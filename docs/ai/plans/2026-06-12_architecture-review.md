...
| P3.1 | ✅ 2026-06-12 — tests/titan/test_chunking.py: chunk_markdown (Header/Overlap-Invarianten), _group_into_windows (Fake-Tokenizer), rrf_fusion, decompose_query-Parsing | titan | M |
